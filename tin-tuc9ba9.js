                        ...
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="Doanh Nghiệp"
                              href="tin-tuc/chinh-phu/doanh-nghiep.html"
                            >
                              <img
                                src="img/posts/Doanh%20nghi%e1%bb%87p.jpg"
                                alt="Doanh Nghiệp"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            ...
                            <div className="desc-news text-home text-split text-split-3">
                              <p>
                                Nghị định về chuyển đổi Công ty Nhà nước được thành
                                lập và hoạt động theo Luật Doanh nghiệp Nhà nước thành
                                công ty TNHH MTV tổ chức và hoạt động theo quy định
                      ...
                      <div className="col-12 col-sm-12 col-md-6 col-lg-4">
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="Tài Chính Nhà Nước"
                              href="tin-tuc/chinh-phu/tai-chinh-nha-nuoc.html"
                            >
                              <img
                                src="img/posts/T%c3%a0i%20ch%c3%adnh%20nh%c3%a0%20n%c6%b0%e1%bb%9bc.jpg"
                                alt="Tài Chính Nhà Nước"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                        ...
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="Thương Mại"
                              href="tin-tuc/chinh-phu/thuong-mai.html"
                            >
                              <img
                                src="img/posts/Th%c6%b0%c6%a1ng%20m%e1%ba%a1i.jpg"
                                alt="Thương Mại"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            ...
                            <div className="desc-news text-home text-split text-split-3">
                              <p>Luật bảo vệ quyền lợi người tiêu dùng</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="news">
                          <div className="pic-news">
                            <a
                              ...
                              href="tin-tuc/chinh-phu/cong-nghe-thong-tin.html"
                            >
                              <img
                                src="img/posts/Facebook%20(900%20x%20900%20px)%20(600%20x%20300%20px)%20(1).jpg"
                            ...
                            <div className="row">
                              <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div className="pic-news">
                                  <a
                                    className="guong"
                                    title="[MBB] - KỸ NĂNG GIÚP BẠN GẮN KẾT VỚI QUẢN LÝ:   VĂN HÓA “PHẢN HỒI TRONG CÔNG VIỆC”"
                                    href="tin-tuc/ky-nang-mem/%5bmbb%5d%c2%a0--ky-nang-giup-ban-gan-ket-voi-quan-ly_---van-hoa-%e2%80%9cphan-hoi-trong-cong-viec%e2%80%9d.html"
                                  >
                                    <img
                                      src="img/posts/40.jpg"
                                      alt="[MBB] - KỸ NĂNG GIÚP BẠN GẮN KẾT VỚI QUẢN LÝ:   VĂN HÓA “PHẢN HỒI TRONG CÔNG VIỆC”"
                                    />
                                  </a>
                                </div>
                              </div>
                                ...
                                <div className="info-news">
                                  <h3 className="name-news name-main">
                                    <a
                                      ...
                                      href="tin-tuc/ky-nang-mem/%5bmbb%5d%c2%a0--ky-nang-giup-ban-gan-ket-voi-quan-ly_---van-hoa-%e2%80%9cphan-hoi-trong-cong-viec%e2%80%9d.html"
                                    >
                                      [MBB]&nbsp;- KỸ NĂNG GIÚP BẠN GẮN KẾT VỚI QUẢN
                                      LÝ: VĂN HÓA “PHẢN HỒI TRONG CÔNG VIỆC”
                                    </a>
                                  </h3>
                                  <div className="desc-news text-split text-split-3">
                                    <p>
                                      ...
                                      >
                                        Văn hóa phản hồi trong công việc là một yếu tố
                                        quan trọng giúp cải thiện mối quan hệ giữa
                                        nhân viên và cấp trên. Đây là một kỹ năng bởi
                                        vì khi được thực hiện đúng cách, không chỉ
                                        giúp bạn thể hiện sự chuyên nghiệp, mà còn
                                        tăng cường sự tin tưởng và sự tôn trọng lẫn
                                        nhau trong môi trường làm việc.
                                      </span>
                                    </p>
                                  </div>
                                </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div className="info-news">
                                  ...
                                  <div className="desc-news text-split text-split-3">
                                    <p>
                                      Thông tư/2025/TT-BTC ban hành phương pháp định
                                      giá chung đối với hang hóa, dịch vụ do Nhà nước
                                      định giá
                                    </p>
                                  </div>
                                </div>
                      ...
                      <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="Thuế - Phí - Lệ Phí, Công Nghệ Thông Tin"
                              href="tin-tuc/chinh-phu/thue---phi---le-phi%2c-cong-nghe-thong-tin.html"
                            >
                              <img
                                src="img/posts/2.jpg"
                                alt="Thuế - Phí - Lệ Phí, Công Nghệ Thông Tin"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            <h3 className="name-news name-main">
                              <a
                                ...
                                href="tin-tuc/chinh-phu/thue---phi---le-phi%2c-cong-nghe-thong-tin.html"
                              >
                                Thuế - Phí - Lệ Phí, Công Nghệ Thông Tin
                              </a>
                            </h3>
                            <div className="desc-news text-split text-split-2">
                              <p>
                                ...
                                >
                                  Thông tư 46/2024/TT-BTC sửa đổi Thông tư
                                  19/2021/TT-BTC hướng dẫn giao dịch điện tử trong
                                  lĩnh vực thuế do Bộ trưởng Bộ Tài chính ban hành
                                </span>
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="Bảo hiểm, Lao động - Tiền lương"
                              href="tin-tuc/chinh-phu/bao-hiem%2c-lao-dong---tien-luong.html"
                            >
                              <img
                                src="img/posts/1.jpg"
                                alt="Bảo hiểm, Lao động - Tiền lương"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            ...
                            <div className="desc-news text-split text-split-2">
                              <p>
                                Luật số: 41/2024/QH15, căn cứ Hiến pháp nước Cộng hòa
                      ...
                      <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="[MBB CN Hà Nội] - Giải Cầu Lông mừng kỷ niệm 10 năm thành lập Trung Tâm Chứng Thực Điện Tử Quốc Gia"
                              href="tin-tuc/tin-tuc-noi-bo/%5bmbb-cn-ha-noi%5d---giai-cau-long-mung-ky-niem-10-nam-thanh-lap-trung-tam-chung-thuc-dien-tu-quoc-gia.html"
                            >
                              <img
                                src="img/posts/38d7f8b9-2b5c-41cd-a900-7def53671519.jpg"
                                alt="[MBB CN Hà Nội] - Giải Cầu Lông mừng kỷ niệm 10 năm thành lập Trung Tâm Chứng Thực Điện Tử Quốc Gia"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            <h3 className="name-news name-main">
                              <a
                                ...
                                href="tin-tuc/tin-tuc-noi-bo/%5bmbb-cn-ha-noi%5d---giai-cau-long-mung-ky-niem-10-nam-thanh-lap-trung-tam-chung-thuc-dien-tu-quoc-gia.html"
                              >
                                [MBB CN Hà Nội] - Giải Cầu Lông mừng kỷ niệm 10 năm
                            ...
                            <div className="desc-news text-split text-split-2">
                              <p>
                                ...
                                >
                                  Ngày 03/08 vừa qua, Chi nhánh Mắt Bão BPO (Hà Nội)
                                  và Axys (Hà Nội) liên quân tham gia “Giải Cầu Lông
                                  mừng kỷ niệm 10 năm thành lập Trung Tâm Chứng Thực
                                  Điện Tử Quốc Gia” cùng với nhiều đơn vị khác&nbsp;
                                  <strong>
                                    như: CMC CA, VNPT CA, VIETTEL CA,FPT CA, MISA
                                    CA,..
                                  </strong>
                                </span>
                              </p>
                      ...
                      <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div className="news">
                          <div className="pic-news">
                            <a
                              className="guong"
                              title="[MBB] - Kỹ Năng Giao Tiếp Công Sở (P.1)"
                              href="tin-tuc/tin-tuc-nganh/%5bmbb%5d---ky-nang-giao-tiep-cong-so-(p.1).html"
                            >
                              <img
                                src="img/posts/NB%20IC_Logoxoanen.jpg"
                                alt="[MBB] - Kỹ Năng Giao Tiếp Công Sở (P.1)"
                              />
                            </a>
                          </div>
                          <div className="info-news">
                            <h3 className="name-news name-main">
                              <a
                                ...
                                href="tin-tuc/tin-tuc-nganh/%5bmbb%5d---ky-nang-giao-tiep-cong-so-(p.1).html"
                              >
                                [MBB] - Kỹ Năng Giao Tiếp Công Sở (P.1)
                              </a>
                            </h3>
                            <div className="desc-news text-split text-split-2">
                              <p>
                              ...
                              <p>
                                ...
                                >
                                  Giao tiếp là yếu tố then chốt trong việc tạo dựng và
                                  duy trì một môi trường làm việc hiệu quả và tích
                                  cực, góp phần vào sự phát triển cá nhân và tổ chức.
                                </span>
                              </p>
                            </div>
                          </div>
